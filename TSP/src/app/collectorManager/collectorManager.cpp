...
void collectorManager::processQuery(JSONCmdData* req) {
    ...
    //             String idStr = parser.getString("id", "a31004");
    ...
    //                         String paramName = paramItem->valuestring;
    //                         int paramValue = valueItem->valueint;
    //                         LOG_DEBUG("GAL Data - Sensor: %s, Param: %s, Value: %d", sensorId.c_str(), paramName.c_str(), paramValue);
    //                     } else {
