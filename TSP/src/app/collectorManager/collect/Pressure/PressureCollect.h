#pragma once
#ifndef PRESSURE_COLLECT_H
#define PRESSURE_COLLECT_H

#include "../../../../module/modbus/modbus_manager.h"
#include "../../../../system/call/base_call.h"
#include "../../../../inc/sys_init.h"

class PressureCollect : public BaseCollector {
private:
    PressureCollect();
    virtual ~PressureCollect();
    PressureCollect(const PressureCollect&) = delete;
    PressureCollect& operator=(const PressureCollect&) = delete;
    static PressureCollect* _instance;
