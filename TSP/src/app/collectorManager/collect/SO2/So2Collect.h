#pragma once
#ifndef SO2_COLLECT_H
#define SO2_COLLECT_H

#include "../../../../module/modbus/modbus_manager.h"
#include "../../../../system/call/base_call.h"
#include "../../../../inc/sys_init.h"

class So2Collect : public BaseCollector {
private:
    So2Collect();
    virtual ~So2Collect();
    So2Collect(const So2Collect&) = delete;
    So2Collect& operator=(const So2Collect&) = delete;
    static So2Collect* _instance;
