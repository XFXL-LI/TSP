#pragma once
#ifndef NOISE_COLLECT_H
#define NOISE_COLLECT_H

#include "../../../../module/modbus/modbus_manager.h"
#include "../../../../system/call/base_call.h"
#include "../../../../inc/sys_init.h"

class NoiseCollect : public BaseCollector {
private:
    NoiseCollect();
    virtual ~NoiseCollect();
    NoiseCollect(const NoiseCollect&) = delete;
    NoiseCollect& operator=(const NoiseCollect&) = delete;
    static NoiseCollect* _instance;
...
public:
    static NoiseCollect& getInstance();
    bool begin() override;
