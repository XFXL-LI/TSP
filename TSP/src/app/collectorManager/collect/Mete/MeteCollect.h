#pragma once
#ifndef METE_COLLECT_H
#define METE_COLLECT_H

#include "../../../../module/modbus/modbus_manager.h"
#include "../../../../system/call/base_call.h"
#include "../../../../inc/sys_init.h"

class MeteCollect : public BaseCollector {
private:
    MeteCollect();
    virtual ~MeteCollect();
    MeteCollect(const MeteCollect&) = delete;
    MeteCollect& operator=(const MeteCollect&) = delete;
    static MeteCollect* _instance;
...
public:
    static MeteCollect& getInstance();
    bool begin() override;
