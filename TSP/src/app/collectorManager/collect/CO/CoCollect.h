...
class CoCollect : public BaseCollector {
private:
    CoCollect();
    virtual ~CoCollect();
    CoCollect(const CoCollect&) = delete;
    CoCollect& operator=(const CoCollect&) = delete;
    static CoCollect* _instance;
