#pragma once
#ifndef PM25_COLLECT_H
#define PM25_COLLECT_H

#include "../../../../module/modbus/modbus_manager.h"
#include "../../../../system/call/base_call.h"
#include "../../../../inc/sys_init.h"

class Pm25Collect : public BaseCollector {
private:
    Pm25Collect();
    virtual ~Pm25Collect();
    Pm25Collect(const Pm25Collect&) = delete;
    Pm25Collect& operator=(const Pm25Collect&) = delete;
    static Pm25Collect* _instance;
...
public:
    static Pm25Collect& getInstance();
    bool begin() override;
