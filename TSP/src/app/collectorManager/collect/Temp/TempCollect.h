#pragma once
#ifndef TEMP_COLLECT_H
#define TEMP_COLLECT_H

#include "../../../../module/modbus/modbus_manager.h"
#include "../../../../system/call/base_call.h"
#include "../../../../inc/sys_init.h"

class TempCollect : public BaseCollector {
private:
    TempCollect();
    virtual ~TempCollect();
    TempCollect(const TempCollect&) = delete;
    TempCollect& operator=(const TempCollect&) = delete;
    static TempCollect* _instance;
...
public:
    static TempCollect& getInstance();
    bool begin() override;
