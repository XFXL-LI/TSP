...
const CommandPermission PERMISSION_TABLE[] = {
    ...
    {"gas_calibration", PermissionLevel::ADMIN},
...
{
public:
    typedef void (*ResponseHandler)(void *eventData, Stream *stream,
...
private:
    ...
    void handleLogout();
    void executeCommand(const String &cmd, String args, Stream *stream);
    ...
    // 回调
    static void onDataQueryRes(void *eventData, Stream *stream,
                               const String &cmd, const String &args);
    ...
    static void onConfigRes(void *eventData, Stream *stream,
                            const String &cmd, const String &args);
    static void onSetConfigRes(void *eventData, Stream *stream,
                               const String &cmd, const String &args);
    static void onGetRecordsRes(void *eventData, Stream *stream,
                                const String &cmd, const String &args);
    static void onGALRes(void *eventData, Stream *stream,
                         const String &cmd, const String &args);
    static void onUpload(void *eventData, Stream *stream,
                         const String &cmd, const String &args);
    static void onDTUCommand(void *eventData, Stream *stream,
                             const String &cmd, const String &args);
    struct User
    {
        String password;
